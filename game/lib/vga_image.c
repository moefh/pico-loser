...
static void draw_image(const struct VGA_IMAGE *img, const unsigned int *data, int img_x, int img_y, bool transparent)
{
  const unsigned int *image_start = data;
  ...
  if (transparent) {
    switch (img_x % 4) {
    case 0: for (int y = 0; y < height; y++) draw_image_line_tr0(line[y+img_y] + img_x/4, image_start + img->stride*y, width); break;
    case 1: for (int y = 0; y < height; y++) draw_image_line_tr1(line[y+img_y] + img_x/4, image_start + img->stride*y, width, skip_first_block); break;
    case 2: for (int y = 0; y < height; y++) draw_image_line_tr2(line[y+img_y] + img_x/4, image_start + img->stride*y, width, skip_first_block); break;
    case 3: for (int y = 0; y < height; y++) draw_image_line_tr3(line[y+img_y] + img_x/4, image_start + img->stride*y, width, skip_first_block); break;
    }
  } else {
    switch (img_x % 4) {
    case 0: for (int y = 0; y < height; y++) draw_image_line0(line[y+img_y] + img_x/4, image_start + img->stride*y, width); break;
    case 1: for (int y = 0; y < height; y++) draw_image_line1(line[y+img_y] + img_x/4, image_start + img->stride*y, width, skip_first_block); break;
    case 2: for (int y = 0; y < height; y++) draw_image_line2(line[y+img_y] + img_x/4, image_start + img->stride*y, width, skip_first_block); break;
    case 3: for (int y = 0; y < height; y++) draw_image_line3(line[y+img_y] + img_x/4, image_start + img->stride*y, width, skip_first_block); break;
    }
  }
}
